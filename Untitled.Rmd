...
```{r}
pps <- function () {
  playerdf <- read.csv(paste0("datasets/players/","MarcusSmart",".csv"), stringsAsFactors = FALSE)
...
count <- c()
pps <- c()
for ( x in seq(-260,260,by=20)) {
  for (y in seq(-60,420,by=20)) {
...
```{r}
playerHeatMap("Trae Young","2018-19",100,FALSE)
playerHeatMap("Trae Young","2018-19",50,FALSE)
playerHeatMap("Trae Young","2018-19",25,FALSE)
playerHeatMap("Trae Young","2018-19",4,FALSE)
playerHeatMap("Trae Young","2018-19",2,FALSE)
playerHeatMap("Trae Young","2018-19",1.5,FALSE)
